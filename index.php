...
<article>
    <div class='align'>
        <h2>Who are We?</h2>
        <p>We at the Alien Nation believe in sovereignty.  You have the right to speak freely and openly about your encounters and your thoughts
            ...
            info on how we started or whats going on, head on over .<a href='about.php'>here</a>. </p>
    </div>
...
<article>
    <div class ="image-wrapper">
        <img src='images/snowdayy.jpg-large' alt='Alien Snow Day'>
            <span class = "align source">Image source: Twitter: @lilmayo</span>
    </div>
    <div>
        <h2>Alien Enjoying The Fresh Snow</h2>
    </div>
    <div class ="divider"></div>

        <div class = "align">
        <p>On December 22, 2016 an alien was spotted in Burlington VT.  It seems that aliens are not that much different than humans after all
        ...
        <a href="new.php#intro">Read More</a></p>
        </div>
    
</article>
<article>
    <div class ="image-wrapper">
            <img src='images/stars.JPG' alt='The Universe'>
            <span class = "align source">Image source: Kevin Gottfried</span>
    </div>
    <div>
        <h2>Are we alone?</h2>
    </div>
    <div class ="divider"></div>
        ...
        <div class = "align">
        <p>Look beyond the clouds to the planets up above.  Do you really think that you are alone in this universe?    
...
<article>
        ...
        <div>
        <h2>Potential E.T. found on Earth</h2>
        </div>
        <div class ="divider"></div>
        <div>
        <p>If this is not proof enough that something exists, I am not sure what we 
        ...
        <a href="new.php#donut">Read More</a></p>
        </div>
</article>

<article>
        <div class ="image-wrapper">
            <img src='images/abduction.JPG' alt='Abduction'>
            <span class="align source">Image source: Kevin Gottfried</span>
        </div>
        <div>
        <h2>Abduction reported in Beverly Hills</h2>
        </div>
        <div class ="divider"></div>
        <div>
        <p>Adrienne reported an Alien encounter on December 21, 2012.  She quotes "I was walking my cat at night when I saw a light at the end of the street. 
            It got closer and closer until I was"...
            <a href="research.php#Adrienne">Read More</a></p>
        </div>
</article>
<article>
        <div class ="image-wrapper">
            <img src='images/baba.jpg' alt='baba'>
        ...
        <div>
        <h2>Baba Vanga the Blind Prophet</h2>
        </div>
        <div class ="divider"></div>
        <div>
        <p>She has the ability to predict things that are going to happen in the future and she even has predicted some things that have 
            ...
            <a href="new.php#baba">Read More</a></p>
        </div>
</article>
